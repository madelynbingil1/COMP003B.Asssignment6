...
namespace COMP003B.Assignment6.Controllers
{
    public class LifetimeDemoController : Controller
    {
        ...
        // Constructor
        public LifetimeDemoController(MyTransientService transientService1, MyScopedService scopedService1, MySingletonService singletonService1, MyTransientService transientService2, MyScopedService scopedService2, MySingletonService singletonService2)
        {
